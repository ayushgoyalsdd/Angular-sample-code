...
export class DashboardComponent implements OnInit {
    ...
    // Paginator for list
    setPaginatorModel(pageNumber: number, pageSize: number): void {
    ...
    //open Modal method
    open(content: HTMLCollection, accountId: string, accountName: string): void {
    ...
    //open dropdown popup
    handleStatusSelected(event: string): void {
